...
files.forEach(file => {
    ...
    // Regex to match <img ... class="bliss-img-asymmetric" ... >
    const regex1 = /<img\s+[^>]*?class=["']([^"']*\s)?bliss-img-asymmetric(\s[^"']*)?["'][^>]*>/gi;
    ...
    content = content.replace(regex1, (match) => {
        ...
        return `<div style="position: relative; padding-right: 40px;">
    ...
    // Regex to match <img ... class="bliss-img-asymmetric-reverse" ... >
    const regex2 = /<img\s+[^>]*?class=["']([^"']*\s)?bliss-img-asymmetric-reverse(\s[^"']*)?["'][^>]*>/gi;
    ...
    content = content.replace(regex2, (match) => {
        ...
        return `<div style="position: relative; padding-left: 40px;">
